...
const skills = [
  ...
  { name: "PSpice", level: 60, category: "tools" },
  ...
  { name: "Public Speaking / Communication", level: 80, category: "soft" },
  { name: "Leadership / Team Collaboration", level: 85, category: "soft" },
  { name: "Customer Service", level: 90, category: "soft" },
  { name: "Entrepreneurship", level: 90, category: "business" },
  { name: "Web Hosting / Portfolio Building", level: 70, category: "tools" },
  { name: "Soldering / Circuit Building", level: 65, category: "hardware" },
];
